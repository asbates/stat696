...
\title{The Effect of New Housing Projects on Expenditures in New York Municipalities} 
\author{Andrew Bates}
...
\begin{abstract}
In this paper we estimate future expenditures for two municipalites in New York based on projected wealth per person, population, percent intergovernmental funding, and growth rate.
\end{abstract}
...
\subsection{Model Building and Diagnostics}
