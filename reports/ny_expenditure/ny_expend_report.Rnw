...
<<r append_hist, echo = FALSE, cache = TRUE, fig.cap = "Histograms of all variables with densities overlayed.">>=
...
Scatter plots of log expenditure vs. log covariate for each covariate.
