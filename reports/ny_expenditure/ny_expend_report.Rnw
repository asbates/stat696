...
<<r regress_summary, echo = FALSE, cache = TRUE, results = "asis", fig.cap = "\\label{tbl:regress} Summary table for regressing log expenditure on log wealth, log population, log percent intergovernmental funding, and log growth rate">>=
...
xtable(regress_tbl, label = "tbl:regress", align = "|l|rrrr|",
         ...
         log wealth, log population, log percent intergovernmental funding,
         and log growth rate")
@
...
\hline
Town & Year & Population & Wealth & \% Intergov Funding  & Growth Rate \\
\hline
