...
something about deccorolation in random forest? does better b/c of high correlations? with mtry = 3 this may be the case. only 3 of 19 variables are considered so even if 3 variables with high correlations are selected, the other highly correlated variables in that group are left out...
