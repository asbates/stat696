...
Data modeling is what is typically taught in statistics courses, the classical example being linear regression. Algorithmic modeling on the other hand is less common in statistics programs and usually finds its place in computer science departments under the term machine learning.However, there has been increased interest in algorithmic modeling recently. Algorithmic modeling on the other hand has seen an increased interest recently

The data modeling approach is what statistics students 


In 2001 Leo Breiman identified two culutures in stastics, differentiated by their approach to modeling data.
...
[^1]: https://trends.google.com/trends/explore?date=all&geo=US&q=machine%20learning
