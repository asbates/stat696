...
```{r salary-hist, fig.width = 7, fig.height = 2.5, fig.cap="Histogram of player salary. The left plot is prior to transformation and the right plot is after log transforming."}
sal_hist <- 
