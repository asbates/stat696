...
The data set used in this analysis is the `Hitters` data from the R package `ISLR` [@R-ISLR] which is a companion package to *An Introduction to Statistical Learning with Applications in R* [@islrbook] containing the data sets used in the book.
