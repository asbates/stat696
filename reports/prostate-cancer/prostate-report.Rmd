---
title: "Analysis of Factors Related to Tumor Penetration of Prostatic Capsule"
author: "Andrew Bates"
...
kable(description,
      caption = "Detailed description of variables included in the data set (except id). The two continuous variables are age and prostate specific antigen value. The remaining variables are categorical.") %>%
...
```{r resid-plot, fig.height = 2.7, fig.width = 6, fig.cap = "Pearson residuals vs. fitted values via Explanatory Variable Patterns (74). The horizontal reference lines indicate the usual residual cutoffs of +-2 and +- 3."}
