...
Additionally, we wish to develop a model to predict capsule penetration so it may be used as a diagnostic tool for future patients.
...
The data set contains six explanatory variables: the patients age and race, results of a digital rectal exam (DRE), whether capsular involvement was detected, prostate specific antigen (PSA) value, and total Gleason score.
Also included in the data set was an identification code which is not used in this analysis as it simply identifies the patient.
...
mention software: R, R Markdown, code available in appendix, etc.
