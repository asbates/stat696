...
```{r psa-hist, fig.cap = "Histogram of prostatic specific antigen value colored by whether tumor penetration of prostatic capsule occured.", fig.height = 3, fig.width = 6}
