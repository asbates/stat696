...
```{r app-race-tab, echo = FALSE}
race_tab <- table(prostate$penetrate,
                  Race = prostate$race)
rownames(race_tab) <- c("No Penetration", "Penetration")
kableExtra::kable(race_tab) %>%
  kableExtra::add_header_above(c(" " = 1, "Race" = 2))

```

```{r app-dre-tab, echo = FALSE}
dre_tab <- table(prostate$penetrate,
                 `DRE Result` = prostate$dre)
rownames(dre_tab) <- c("No Penetration", "Penetration")
kableExtra::kable(dre_tab) #%>%
  #kableExtra::add_header_above(c(" " = 1, "DRE Result" = 2))
